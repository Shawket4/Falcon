...
Future<String> get loadData async {
  if (DriverList.isEmpty) {
    var res = await dio.post("$SERVER_IP/api/GetDriverProfileData").then((
        response) {
      ...
      body: FutureBuilder(
          ...
          builder: (context, snapshot) {
            if (snapshot.hasData) {
             ...
             //  );
              return DriverList.isEmpty ? const Center(child: Text("No Drivers Found"),) : GroupedListView<dynamic, String>(
                  physics: const BouncingScrollPhysics(),
