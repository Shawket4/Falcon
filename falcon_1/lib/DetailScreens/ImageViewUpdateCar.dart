...
class ImageViewUpdateCar extends StatefulWidget {
  ImageViewUpdateCar(
      {Key? key, this.images, required this.name, required this.carType})
  ...
  @override
  State<ImageViewUpdateCar> createState() => _ImageViewUpdateCarState();
}

String? title = "";

class _ImageViewUpdateCarState extends State<ImageViewUpdateCar> {
