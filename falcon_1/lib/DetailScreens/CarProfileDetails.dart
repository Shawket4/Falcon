// ignore_for_file: file_names, unused_local_variable, deprecated_member_use, use_build_context_synchronously
  ...
  Future<Object> loadData(String CarNoPlate) async {
    ...
    if (widget.car["CalibrationLicenseImageName"] != "") {
      ...
      if (carCalibrationFront.statusCode == HttpStatus.ok) {
        final Uint8List calibrationLicenceBytes = carCalibrationFront.bodyBytes;
